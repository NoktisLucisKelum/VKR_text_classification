...
models_list = ["DeepPavlov/rubert-base-cased-sentence", "DeepPavlov/rubert-base-cased", "blinoff/roberta-base-russian-v0"]
...
for i in models_list:
    if i == "sergeyzh/rubert-tiny-turbo" or i == "cointegrated/rubert-tiny2":
        length = 2024
        lrt = 1e-4
        b = 12
    elif i == "ai-forever/ruRoberta-large":
        length = 512
        lrt = 3e-4
        b = 12
    elif i == "ai-forever/sbert_large_nlu_ru" or i == "ai-forever/ruElectra-large":
        length = 512
        lrt = 3e-4
        b = 12
    else:
    ...
    for epoch in range(epochs):
        ...
        for step, batch in enumerate(train_loader):
            ...
            # Выведем статистику
            print(f"Model: {i}, Batch {step + 1}/{len(train_loader)}, Loss: {loss.item():.4f}, F1 (weighted): {f1_weighted:.4f}, "
        ...
        print(f"Model: {i}, Validation F1 (weighted): {val_f1_weighted:.4f}, Validation F1 (macro): {val_f1_macro:.4f},"
