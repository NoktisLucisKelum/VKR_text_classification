...
df = pd.read_csv('/Users/denismazepa/Desktop/Py_projects/VKR/datasets/datasets_final/for_1_level/test_refactored_lematize.csv', dtype={'RGNTI1': str, 'RGNTI2': str, 'RGNTI3': str})
...
preprocessor_1.save_dataset('/Users/denismazepa/Desktop/Py_projects/VKR/datasets/datasets_final/for_other_levels/test_refactored_lematize_2_3_level.csv')


df_new = pd.read_csv('/Users/denismazepa/Desktop/Py_projects/VKR/datasets/datasets_final/for_1_level/train_refactored_lematize.csv', dtype={'RGNTI1': str, 'RGNTI2': str, 'RGNTI3': str})
# print(df["RGNTI1"].dtype)
# print(df[df['RGNTI1'] == '58'])
...
preprocessor.save_dataset('/Users/denismazepa/Desktop/Py_projects/VKR/datasets/datasets_final/for_other_levels/train_refactored_lematize_2_3_level.csv')
